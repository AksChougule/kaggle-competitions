...
# install.packages(c('ggmap','ggplot2','dplyr','gridExtra','caret','dbscan','MASS','ggExtra','LiblineaR','readr'))
...
setwd(dir = '~/datasets/Kaggle/competitions/sf-crime/')

# Loading data and map:
data_train <-
    read_csv(file="data/sf-crime/train.csv")
data_test <-
    read_csv(file="data/sf-crime/test.csv") 
